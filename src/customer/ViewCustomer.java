...
public class ViewCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tvViewCustomer = new javax.swing.JLabel();
        ...
        tvSearchBox.setPreferredSize(new java.awt.Dimension(8, 30));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(33, 33, 33)
                                .addComponent(tvSearchBox, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(379, 379, 379)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(tvFirstName, javax.swing.GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE)))
                .addGap(100, 100, 100))
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(163, 163, 163)
        ...
        tvViewCustomer.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        tvViewCustomer.setForeground(new java.awt.Color(255, 0, 0));
        tvViewCustomer.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        tvViewCustomer.setText("View Customers");
        tvViewCustomer.setAlignmentX(getAlignmentX());
    ...
    public void menuAddSupplierActionPerformed(java.awt.event.ActionEvent evt) {
    	dispose();
    	new AddSupplier().setVisible(true);
    }
 public void menuAddCustomerActionPerformed(java.awt.event.ActionEvent evt) {
    	dispose();
    	new AddCustomer().setVisible(true);
    }

 
 public void menuViewSupplierActionPerformed(java.awt.event.ActionEvent evt) {
	 dispose();
    ...
    private void tvAddressActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        updateCustomer(supplierBeingEdited);
    }                                         
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        if(supplierBeingEdited!=null){
            deleteCustomer(supplierBeingEdited);
        }
    }                                         
...
//            String[] customer=new String[8];
        ...
        String[][] mSuppliers=new String[customers.size()][8];
        for(int i=0;i<customers.size();i++){
            for(int j=0;j<customers.get(i).size();j++){
            mSuppliers[i][j]=customers.get(i).get(j);
                    }
        }
    ...
    public void updateCustomer(Supplier supplier){
        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy-MM-dd");  
        LocalDateTime now = LocalDateTime.now();
        String date=dtf.format(now);
        	String query="UPDATE customers set "+"first_name="+"\'"+supplier.firstName+"\'"+",last_name="+"\'"+supplier.lastName+"\'"+",email="+"\'"+supplier.email+"\'"+",mobile="+"\'"+supplier.mobile+"\'"+",address="+"\'"+supplier.address+"\'"+",updated_date="+"\'"+date+"\'"+" WHERE id="+"\'"+supplier.id+"\'";
                System.out.println(query);
                QueryResponse qs=service.executeUpdate(query);
                if(qs.statusCode==1){
                    fetchAllCustomers();
                    JOptionPane.showMessageDialog(null, "Customer Details Updated SuccessFully","Info", JOptionPane.INFORMATION_MESSAGE, null);
                }else{
                    JOptionPane.showMessageDialog(null, qs.message,"Error", JOptionPane.ERROR_MESSAGE, null);
                }
    }
    
    public void deleteCustomer(Supplier supplier){
      
       
        	String query="DELETE from customers where id = "+"\'"+supplierBeingEdited.id+"\'";
                System.out.println(query);
                QueryResponse qs=service.executeUpdate(query);
                if(qs.statusCode==1){
                    fetchAllCustomers();
                    ...
                    JOptionPane.showMessageDialog(null, "Customer Deleted SuccessFully","Info", JOptionPane.INFORMATION_MESSAGE, null);
                }else{
                    JOptionPane.showMessageDialog(null, qs.message,"Error", JOptionPane.ERROR_MESSAGE, null);
                }
    }
    ...
    private javax.swing.JLabel tvViewCustomer;
